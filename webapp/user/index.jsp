...
<script type="text/javascript">
	$(function(){
		var i = <%=request.getAttribute("hotList")==null%>;
		if(i){
			location.href="${pageContext.request.contextPath }/productServlet?method=findProducts";
		}
	});
</script>
	<body>
			...
			<div class="container-fluid">
				...
				<c:forEach var="i" items="${hotList }">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><a href="${pageContext.request.contextPath }/productServlet?method=findProductById&pid=${i.pid }" style='color:#666'>${i.pname }</a></p>
						<p><font color="#E4393C" style="font-size:16px">&yen;${i.shop_price }</font></p>
					</div>
				</c:forEach>
