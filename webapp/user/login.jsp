...
<form class="form-horizontal" action="${pageContext.request.contextPath }/userServlet" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <img id="validateCode" src="${pageContext.request.contextPath }/userServlet?method=validateCode"/>
    </div>
    <script type="text/javascript">
    $("#validateCode").click(function(){
    	this.src="${pageContext.request.contextPath }/userServlet?method=validateCode&time="+new Date().getTime();
    });
