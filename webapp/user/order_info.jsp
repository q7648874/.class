...
<html>
	...
	<body>
		...
		<div class="container">
				...
				<div style="margin:0 auto;margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach var="oi" items="${order.orderitem }">
							<tr class="active">
								...
								<td width="15%">
									<span class="subtotal">￥${oi.count * oi.p.shop_price }</span>
									<c:set var="sum" value="${oi.count * oi.p.shop_price + sum }"></c:set>
								</td>
							</tr>
							</c:forEach>
						</tbody>
			...
			<div>
				<hr/>
				<form class="form-horizontal" id="orderForm" action="payServlet" method="post" style="margin-top:5px;margin-left:150px;">
					<div class="form-group">
						<label for="username" class="col-sm-1 control-label">地址</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" id="username" name="address" placeholder="请输入收货地址">
							<input hidden="hidden" name="method" value="pay">
							<input hidden="hidden" name="money" value="${sum }">
							<input hidden="hidden" name="oid" value="${order.oid }">
						</div>
					</div>
					<div class="form-group">
